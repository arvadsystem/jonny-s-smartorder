...
assert.match(useVentasSource, /`bootstrap:\$\{cajaUserKey\}:\$\{idSucursal \|\| 'auto'\}`/, 'bootstrap debe cachearse por usuario y sucursal');
assert.match(useVentasSource, /`\$\{cajaUserKey\}:\$\{idSucursal\}:\$\{idTipoDepartamento \|\| 'ALL'\}`/, 'recetas deben usar cache por usuario, sucursal y departamento');
assert.match(useVentasSource, /`\$\{catalogKey\}:\$\{cajaUserKey\}:\$\{idSucursal\}`/, 'catalogos de Caja deben usar cache por usuario y sucursal');
...
assert.match(useVentasSource, /recipeCatalogCacheRef[\s\S]*`\$\{cajaUserKey\}:\$\{idSucursal\}:\$\{idTipoDepartamento \|\| 'ALL'\}`/, 'recetas deben usar cache por usuario, sucursal y departamento');
