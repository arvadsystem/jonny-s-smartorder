...
export const inventarioService = {
  ...
  // ==============================
  // ALMACENES (NUEVO SUBMÓDULO)
  // ==============================
  // COMENTARIO EN MAYÚSCULAS: CRUD DE ALMACENES (TABLA: id_almacen, id_sucursal, nombre)
  ...
  eliminarAlmacen: (id) =>
    ...
    // ==============================
    // COMENTARIO EN MAYÚSCULAS: PRODUCTOS (SI NO EXISTE EN TU SERVICE, AGREGA ESTO)
    // ==============================
    getProductos: () => apiFetch('/productos', 'GET'),

    // ==============================
    // COMENTARIO EN MAYÚSCULAS: MOVIMIENTOS INVENTARIO (KARDEX)
    // ==============================
