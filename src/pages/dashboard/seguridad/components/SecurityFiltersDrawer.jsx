const SecurityFiltersDrawer = ({
  open = false,
  onClose,
  onApply,
  onClear,
  title = "Ajusta el estado y el orden de la vista",
  chips = [],
  children,
  applyLabel = "Aplicar",
  clearLabel = "Limpiar",
  drawerId = "sec-filters-drawer",
}) => (
  <>
    <div
    ...
    <aside
      className={`inv-prod-drawer inv-cat-v2__drawer inv-cat-v2__drawer--filters ${open ? "show" : ""}`.trim()}
      id={drawerId}
      role="dialog"
      aria-modal="true"
      aria-hidden={!open}
...
export default SecurityFiltersDrawer;
