...
export default function SucursalFormDrawer({
  ...
  return createPortal(
    <>
      ...
      />
      <aside
        className="inv-prod-drawer inv-cat-v2__drawer suc-form-modal show"
        role="dialog"
        aria-modal="true"
        aria-hidden={!open}
        aria-labelledby="suc-form-title"
      >
        <div className="inv-prod-drawer-head suc-form-modal__head">
          <i className="bi bi-shop-window inv-cat-v2__drawer-mark" aria-hidden="true" />
          <div>
            <div className="inv-prod-drawer-sub">Sucursales</div>
            <div className="inv-prod-drawer-title" id="suc-form-title">
              {mode === 'create' ? 'Nueva sucursal' : 'Editar sucursal'}
            </div>
            <div className="suc-form-modal__intro">
              Registra la información general, contacto, operación e imagen de la sucursal.
            </div>
          </div>
          <button
            type="button"
        ...
        <form className="suc-form-modal__form" onSubmit={onSubmit}>
          <div className="inv-prod-drawer-body inv-cat-v2__drawer-body suc-form-modal__body">
          ...
          <div className="inv-prod-drawer-actions inv-cat-v2__drawer-actions suc-form-modal__actions">
