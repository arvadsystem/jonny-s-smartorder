  ...
  return (
    <section className="sol-comp-section" aria-labelledby="sol-comp-title">
      <header className="sol-comp-header">
        ...
        <div className="sol-comp-header-actions">{canCreate ? <button type="button" className="btn btn-primary sol-comp-primary-action" onClick={onCreate}><i className="bi bi-plus-circle" aria-hidden="true" /> Nueva solicitud</button> : null}{canQuickCaptureCreate ? <button type="button" className="btn btn-outline-primary" onClick={onQuickCapture}><i className="bi bi-camera" aria-hidden="true" /> Compra rápida</button> : null}{canQuickCaptureAdmin ? <button type="button" className="btn btn-outline-primary" onClick={onQuickCaptureAdmin}><i className="bi bi-inboxes" aria-hidden="true" /> Capturas rápidas</button> : null}</div>
      </header>
