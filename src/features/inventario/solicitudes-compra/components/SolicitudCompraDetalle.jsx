...
export default function SolicitudCompraDetalle({ state, onBack, onRetry }) {
  ...
  return (
    <section className="sol-comp-section">
      ...
      <div className="sol-comp-detail-lines">{details.map((line, index) => (
        <article key={line.id_solicitud_detalle || `${line.tipo_item}-${line.id_item}-${index}`}>
